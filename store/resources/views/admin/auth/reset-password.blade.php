@php
    $title ??= 'Atur Ulang Password · MasFirmanPratama.com';
@endphp
<!DOCTYPE html>
            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center pt-10">
                    <div>
                        ...
                        <div>
                            @if ($errors->any())
                                <div class="mb-5 rounded-lg border border-error-200 bg-error-50 px-4 py-3 text-sm text-error-600 dark:border-error-800 dark:bg-error-900/20 dark:text-error-400">
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" placeholder="admin@masfirmanpratama.com"
